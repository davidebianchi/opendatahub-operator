...
//  3. NamespaceImmutability — verify namespace fields cannot be changed
...
//  6. GarbageCollectionOnDelete — deletes the CR (must be last)
//
// This test uses custom namespaces to verify non-default namespace handling.
